import type { Editor, TLPointerEventInfo, TLShape } from '@tldraw/editor';
import { StateNode } from '@tldraw/editor'
// guarded: arrow not yet converted — isOverArrowLabel lives in shapes/arrow/arrowLabel.
// Stand-in returns false so geo shapes never route into the arrow-label state.
const isOverArrowLabel = (_editor: Editor, _shape: TLShape): boolean => false
