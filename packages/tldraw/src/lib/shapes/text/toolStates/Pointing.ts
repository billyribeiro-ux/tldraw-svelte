import type { TLPointerEventInfo, TLShapeId, TLTextShape } from '@tldraw/editor'
import { StateNode, Vec, createShapeId, isShapeId, maybeSnapToGrid, toRichText } from '@tldraw/editor'
