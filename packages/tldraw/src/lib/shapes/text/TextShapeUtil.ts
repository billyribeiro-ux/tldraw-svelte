...
export class TextShapeUtil extends ShapeUtil<TLTextShape> {
	...
	component(_shape: TLTextShape) {
		// Svelte port: rendering is handled by the Svelte component (using the
		// shared RichTextLabel.svelte), not by a React component() method.
		return null
	}
	...
	override toSvg(_shape: TLTextShape, _ctx: SvgExportContext) {
		// Svelte port: the original returned React JSX (RichTextSVG). SVG export
		// is handled by the Svelte renderer instead.
