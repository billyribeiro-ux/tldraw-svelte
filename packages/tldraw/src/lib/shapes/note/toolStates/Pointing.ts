import type { Editor, TLNoteShape, TLPointerEventInfo, TLShapeId } from '@tldraw/editor'
import { StateNode, Vec, createShapeId, maybeSnapToGrid } from '@tldraw/editor'
import { startEditingShapeWithRichText } from '../../../tools/SelectTool/selectHelpers'
import { getDisplayValues } from '../../shared/getDisplayValues'
import { NOTE_ADJACENT_POSITION_SNAP_RADIUS, getAvailableNoteAdjacentPositions } from '../noteHelpers'
