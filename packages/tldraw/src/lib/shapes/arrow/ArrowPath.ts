import { exhaustiveSwitchError, type TLArrowShape } from '@tldraw/editor'
import { PathBuilder, type PathBuilderOpts } from '../shared/PathBuilder'
import { type TLArrowInfo } from './arrow-types'
