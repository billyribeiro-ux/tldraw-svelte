import { Ellipse2d, type Geometry2dOptions, Rectangle2d, type VecLike } from '@tldraw/editor'
import { type ImageAlphaGeometryConfig, isImagePointTransparent } from './ImageAlphaCache'
