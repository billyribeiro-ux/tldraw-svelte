...
import type { TLRichText} from '../misc/TLRichText';
import { richTextValidator, toRichText } from '../misc/TLRichText'
import { createShapePropsMigrationIds, createShapePropsMigrationSequence } from '../records/TLShape'
import type { RecordProps } from '../recordsWithProps'
import { StyleProp } from '../styles/StyleProp'
import type {
	TLDefaultColorStyle} from '../styles/TLColorStyle';
import {
	DefaultColorStyle,
	DefaultLabelColorStyle
} from '../styles/TLColorStyle'
import type { TLDefaultDashStyle } from '../styles/TLDashStyle';
import { DefaultDashStyle } from '../styles/TLDashStyle'
import type { TLDefaultFillStyle } from '../styles/TLFillStyle';
import { DefaultFillStyle } from '../styles/TLFillStyle'
import type { TLDefaultFontStyle } from '../styles/TLFontStyle';
import { DefaultFontStyle } from '../styles/TLFontStyle'
import type {
	TLDefaultHorizontalAlignStyle} from '../styles/TLHorizontalAlignStyle';
import {
	DefaultHorizontalAlignStyle
} from '../styles/TLHorizontalAlignStyle'
import type { TLDefaultSizeStyle } from '../styles/TLSizeStyle';
import { DefaultSizeStyle } from '../styles/TLSizeStyle'
import type {
	TLDefaultVerticalAlignStyle} from '../styles/TLVerticalAlignStyle';
import {
	DefaultVerticalAlignStyle
} from '../styles/TLVerticalAlignStyle'
import type { TLBaseShape } from './TLBaseShape'
