import type { LegacyMigrations, MigrationSequence, StoreValidator } from '@tldraw/store';
import { StoreSchema } from '@tldraw/store'
import { objectMapValues } from '@tldraw/utils'
import type { T } from '@tldraw/validate'
import type { TLBaseAsset } from './assets/TLBaseAsset'
...
import type {
	TLDefaultAsset,
	TLUnknownAsset} from './records/TLAsset';
import {
	assetMigrations,
	createAssetRecordType,
} from './records/TLAsset'
import type { TLBinding, TLDefaultBinding} from './records/TLBinding';
import { createBindingRecordType } from './records/TLBinding'
import { CameraRecordType, cameraMigrations } from './records/TLCamera'
import type {
	CustomRecordInfo} from './records/TLCustomRecord';
import {
...
import type { TLRecord } from './records/TLRecord'
import type {
	TLDefaultShape,
	TLShape} from './records/TLShape';
import {
...
import type { RecordProps, TLPropsMigrations} from './recordsWithProps';
import { processPropsMigrations } from './recordsWithProps'
...
import type { StyleProp } from './styles/StyleProp'
import type { TLStoreProps} from './TLStore';
import { createIntegrityChecker, onValidationFailure } from './TLStore'
