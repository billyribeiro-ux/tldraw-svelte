...
import type { TLAsset, TLAssetId } from './records/TLAsset'
import type { TLCameraId } from './records/TLCamera';
...
import type { TLInstancePageStateId } from './records/TLPageState';
