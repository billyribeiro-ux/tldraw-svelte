...
import type { SetValue } from '../util-types'
import type { VecModel} from './geometry-types';
import { vecModelValidator } from './geometry-types'
import type { TLCanvasUiColor} from './TLColor';
import { canvasUiColorTypeValidator } from './TLColor'
