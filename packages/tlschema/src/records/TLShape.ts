...
import type { SchemaPropsInfo } from '../createTLSchema'
import type { TLPropsMigrations } from '../recordsWithProps'
import type { TLArrowShape } from '../shapes/TLArrowShape'
import type { TLBaseShape} from '../shapes/TLBaseShape';
import { createShapeValidator } from '../shapes/TLBaseShape'
import type { TLBookmarkShape } from '../shapes/TLBookmarkShape'
import type { TLDrawShape } from '../shapes/TLDrawShape'
import type { TLEmbedShape } from '../shapes/TLEmbedShape'
import type { TLFrameShape } from '../shapes/TLFrameShape'
import type { TLGeoShape } from '../shapes/TLGeoShape'
import type { TLGroupShape } from '../shapes/TLGroupShape'
import type { TLHighlightShape } from '../shapes/TLHighlightShape'
import type { TLImageShape } from '../shapes/TLImageShape'
import type { TLLineShape } from '../shapes/TLLineShape'
import type { TLNoteShape } from '../shapes/TLNoteShape'
import type { TLTextShape } from '../shapes/TLTextShape'
import type { TLVideoShape } from '../shapes/TLVideoShape'
import { StyleProp } from '../styles/StyleProp'
import type { TLPageId } from './TLPage'
