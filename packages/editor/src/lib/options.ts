import type { Awaitable } from '@tldraw/utils'
import { DEFAULT_CAMERA_OPTIONS } from './constants'
import type { Editor } from './editor/Editor'
import type { TLContent } from './editor/types/clipboard-types'
import type { TLExternalContent } from './editor/types/external-content'
import type { TLCameraOptions } from './editor/types/misc-types'
import type { VecLike } from './primitives/Vec'
import type { TLDeepLinkOptions } from './utils/deepLinks'
import type { TLTextOptions } from './utils/richText'
...
export interface TldrawOptions {
	...
	/**
	 * The provider component to wrap shapes in when exporting an image, for shapes that
	 * depend on external context providers. Framework-agnostic in this Svelte port: the
	 * type is opaque and the default is a no-op. Wired up when SVG export is ported.
	 */
	readonly exportProvider: unknown
	/**
