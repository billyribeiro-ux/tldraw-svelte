import type { TLHandle, TLShape, VecModel } from '@tldraw/tlschema'
import type { VecLike } from '../../primitives/Vec'
import type { TLOverlay } from '../overlays/OverlayUtil'
import type { TLSelectionHandle } from './selection-types'
