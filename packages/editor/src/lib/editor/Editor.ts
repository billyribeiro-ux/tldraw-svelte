...
import type {
	...
	StoreSideEffects,
	StoreSnapshot,
	UnknownRecord} from '@tldraw/store';
import {
	reverseRecordsDiff,
} from '@tldraw/store'
import type {
	...
	TLUser,
	TLUserId,
	TLVideoAsset} from '@tldraw/tlschema';
import {
	CameraRecordType,
...
import type { TLCurrentUser} from '../config/createTLCurrentUser';
import { createTLCurrentUser } from '../config/createTLCurrentUser'
import type { TLAnyAssetUtilConstructor} from '../config/defaultAssets';
import { checkAssets } from '../config/defaultAssets'
import type { TLAnyBindingUtilConstructor} from '../config/defaultBindings';
import { checkBindings } from '../config/defaultBindings'
import type { TLAnyShapeUtilConstructor} from '../config/defaultShapes';
import { checkShapesAndAddCore } from '../config/defaultShapes'
import type {
	TLEditorSnapshot,
	TLLoadSnapshotOptions} from '../config/TLEditorSnapshot';
import {
	getSnapshot,
	loadSnapshot,
...
import type { TldrawOptions} from '../options';
import { defaultTldrawOptions } from '../options'
import type { BoxLike } from '../primitives/Box';
import { Box } from '../primitives/Box'
import { EASINGS } from '../primitives/easings'
import type { Geometry2d } from '../primitives/geometry/Geometry2d'
import { Group2d } from '../primitives/geometry/Group2d'
import { intersectPolygonPolygon } from '../primitives/intersect'
import type { MatLike } from '../primitives/Mat';
...
import type {
	TLDeepLink,
	TLDeepLinkOptions} from '../utils/deepLinks';
import {
...
import type { TLTextOptions, TiptapEditor } from '../utils/richText'
import { applyRotationToSnapshotShapes, getRotationSnapshot } from '../utils/rotation'
import type { ReadonlySharedStyleMap, SharedStyle} from '../utils/SharedStylesMap';
import { SharedStyleMap } from '../utils/SharedStylesMap'
import type { AssetUtil } from './assets/AssetUtil'
import type { BindingOnDeleteOptions, BindingUtil } from './bindings/BindingUtil'
...
import type { TLAnyOverlayUtilConstructor } from './overlays/OverlayUtil'
import type {
	ShapeUtil,
	TLEditStartInfo,
	TLGeometryOpts,
...
import type { StateNode, TLStateNodeConstructor } from './tools/StateNode'
import type { TLContent } from './types/clipboard-types'
import type { TLEventMap } from './types/emit-types'
import type { TLEventInfo, TLPointerEventInfo } from './types/event-types'
import type { TLExternalAsset, TLExternalContent } from './types/external-content'
import type { TLHistoryBatchOptions } from './types/history-types'
import type {
	OptionalKeys,
	RequiredKeys,
	TLCameraMoveOptions,
...
import type { TLAdjacentDirection, TLResizeHandle } from './types/selection-types'
