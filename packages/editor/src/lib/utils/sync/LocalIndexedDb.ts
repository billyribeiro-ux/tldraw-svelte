import type { RecordsDiff, SerializedSchema, SerializedStore } from '@tldraw/store'
import type { TLRecord, TLStoreSchema } from '@tldraw/tlschema'
import { assert, getFromLocalStorage, noop, setInLocalStorage } from '@tldraw/utils'
import type { IDBPDatabase, IDBPTransaction} from 'idb';
import { deleteDB, openDB } from 'idb'
import type { TLSessionStateSnapshot } from '../../config/TLSessionStateSnapshot'
